...
#
#  $ bin/test -s mingtak.snmp -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src mingtak.snmp.testing.MINGTAK_SNMP_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/mingtak/snmp/tests/robot/test_example.robot
#
